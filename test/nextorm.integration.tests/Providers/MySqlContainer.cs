...
/// </summary>
internal static class MySqlContainer
{
    ...
    private static Testcontainers.MySql.MySqlContainer? _container;
    ...
    /// <summary>The reason MySQL is unavailable, or <c>null</c> when it is available.</summary>
    ...
    public static string ConnectionString
    {
        get
        {
            ...
            return _connectionString
                ?? throw new InvalidOperationException(_failure ?? "MySQL is not available.");
        }
    }
    ...
    private static void Resolve()
    {
        ...
        lock (Gate)
        {
            ...
            {
                _failure =
                    $"Could not start a MySQL test container ({exception.Message}). " +
