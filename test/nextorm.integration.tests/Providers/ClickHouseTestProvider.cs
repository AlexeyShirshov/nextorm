...
internal sealed class ClickHouseTestProvider : ITestProvider
{
    ...
    public IDataContext CreateContext() =>
        new ClickHouseDbContext(ClickHouseContainer.ConnectionString, new DbContextBuilder());
    ...
    public void EnsureSeeded()
    {
        ...
        lock (SeedGate)
        {
            ...
            using var ctx = new ClickHouseDbContext(ClickHouseContainer.ConnectionString, new DbContextBuilder());
