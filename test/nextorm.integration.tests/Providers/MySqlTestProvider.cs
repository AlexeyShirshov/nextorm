...
internal sealed class MySqlTestProvider : ITestProvider
{
    ...
    public IDataContext CreateContext() =>
        new MySqlDbContext(MySqlContainer.ConnectionString, new DbContextBuilder());
    ...
    public void EnsureSeeded()
    {
        ...
        lock (SeedGate)
        {
            ...
            using var ctx = new MySqlDbContext(MySqlContainer.ConnectionString, new DbContextBuilder());
