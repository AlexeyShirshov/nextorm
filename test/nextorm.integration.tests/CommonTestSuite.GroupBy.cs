...
public abstract partial class CommonTestSuite
{
    ...
    public void TestGroup_Limit()
    {
        ...
        var r = _sut.ComplexEntity.GroupBy(e => new { e.Int }).Select(e => new { e.Int, count = NORM.SQL.count() }).OrderBy(2, OrderDirection.Asc).First();
    ...
    public void TestGroup_Sort()
    {
        ...
        var r = _sut.ComplexEntity.Where(e => e.Int != null).GroupBy(e => new { e.Int }).Select(e => new { e.Int, count = NORM.SQL.count() }).OrderBy(1, OrderDirection.Desc).First();
