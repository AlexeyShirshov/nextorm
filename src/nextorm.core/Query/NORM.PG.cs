...
/// Exposed through <see cref="NORM.PG_SQL"/>; every member is gated by a capability flag and
/// rejected by providers that do not opt in.
/// </summary>
public static partial class NORM
{
    /// <summary>PostgreSQL-only functions; see <see cref="NORM.PG_SQL"/>.</summary>
    public class PG : NORM_SQL
    {
        /// <summary>
