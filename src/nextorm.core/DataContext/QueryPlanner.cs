...
internal sealed class QueryPlanner : IQueryPlanner
{
    ...
    internal (string? WithSql, string Sql, List<Parameter> Parameters) RenderSource(QueryCommand source, IParameterProvider? parameterProvider, List<Parameter>? parameters)
    {
