...
/// </summary>
/// <remarks>
/// Named after the algorithm so it does not collide with <see cref="System.HashCode"/>. Algorithm
...
public struct XxHash32
{
    ...
    {
        var result = RandomNumberGenerator.GetBytes(sizeof(uint));
    ...
    {
        uint hc1 = (uint)(value1 is null ? 0 : value1.GetHashCode());
        uint hc2 = (uint)(value2 is null ? 0 : value2.GetHashCode());
    ...
    public static int Combine<T1, T2, T3>(T1 value1, T2 value2, T3 value3)
    {
        uint hc1 = (uint)(value1 is null ? 0 : value1.GetHashCode());
        uint hc2 = (uint)(value2 is null ? 0 : value2.GetHashCode());
        uint hc3 = (uint)(value3 is null ? 0 : value3.GetHashCode());
    ...
    public static int Combine<T1, T2, T3, T4>(T1 value1, T2 value2, T3 value3, T4 value4)
    {
        ...
        uint hc2 = (uint)(value2 is null ? 0 : value2.GetHashCode());
        uint hc3 = (uint)(value3 is null ? 0 : value3.GetHashCode());
        uint hc4 = (uint)(value4 is null ? 0 : value4.GetHashCode());
    ...
    public static int Combine<T1, T2, T3, T4, T5>(T1 value1, T2 value2, T3 value3, T4 value4, T5 value5)
    {
        ...
        uint hc3 = (uint)(value3 is null ? 0 : value3.GetHashCode());
        uint hc4 = (uint)(value4 is null ? 0 : value4.GetHashCode());
        uint hc5 = (uint)(value5 is null ? 0 : value5.GetHashCode());
    ...
    public static int Combine<T1, T2, T3, T4, T5, T6>(T1 value1, T2 value2, T3 value3, T4 value4, T5 value5, T6 value6)
    {
        ...
        uint hc4 = (uint)(value4 is null ? 0 : value4.GetHashCode());
        uint hc5 = (uint)(value5 is null ? 0 : value5.GetHashCode());
        uint hc6 = (uint)(value6 is null ? 0 : value6.GetHashCode());
    ...
    public static int Combine<T1, T2, T3, T4, T5, T6, T7>(T1 value1, T2 value2, T3 value3, T4 value4, T5 value5, T6 value6, T7 value7)
    {
        ...
        uint hc5 = (uint)(value5 is null ? 0 : value5.GetHashCode());
        uint hc6 = (uint)(value6 is null ? 0 : value6.GetHashCode());
        uint hc7 = (uint)(value7 is null ? 0 : value7.GetHashCode());
    ...
    public static int Combine<T1, T2, T3, T4, T5, T6, T7, T8>(T1 value1, T2 value2, T3 value3, T4 value4, T5 value5, T6 value6, T7 value7, T8 value8)
    {
        ...
        uint hc6 = (uint)(value6 is null ? 0 : value6.GetHashCode());
        uint hc7 = (uint)(value7 is null ? 0 : value7.GetHashCode());
        uint hc8 = (uint)(value8 is null ? 0 : value8.GetHashCode());
    ...
    public void AddBytes(ReadOnlySpan<byte> value)
    {
        ...
        // Usually Add calls Initialize but if we haven't used XxHash32 before it won't have been called.
        if (_length == 0)
        {
