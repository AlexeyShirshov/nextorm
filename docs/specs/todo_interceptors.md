# WIP: Интерцепторы (hooks) по образцу linq2db

> Рабочий план (design RFC). Источник: `linq2db-comparison.md:54,81` — разрыв в расширяемости
...
- Документация: новый гайд `docs/guide/19-interceptors.md` (+ `docs/ru/guide/`), `docs/advanced/
  api-reference.md` (+RU), `docs/advanced/limitations.md` (+RU), `linq2db-comparison.md`,
